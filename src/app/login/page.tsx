...
function LoginForm() {
  ...
  return (
    <div className="max-w-md w-full space-y-8 bg-white p-8 sm:p-10 rounded-3xl border border-gray-100 shadow-xl relative z-10">
      ...
      <div className="p-5 bg-primary/5 border border-primary/10 rounded-2xl space-y-3">
        <div className="flex items-center gap-2 text-primary">
          ...
          <h4 className="font-league font-bold text-sm tracking-wider uppercase">Demo Credentials</h4>
        </div>
        <p className="text-[10px] text-gray-600 leading-relaxed">
          The authentication engine supports database-resilient fallback login. Use any credentials below to review user roles:
        </p>
        <ul className="space-y-2 text-[10px] text-gray-500 font-medium">
          <li className="flex justify-between border-b border-gray-100 pb-1">
            <span>👤 <strong>Admin Console Login:</strong></span>
            <span className="font-mono text-primary font-bold">admin@prithvora.com</span>
          </li>
          <li className="flex justify-between border-b border-gray-100 pb-1">
            <span>👤 <strong>Standard User Login:</strong></span>
